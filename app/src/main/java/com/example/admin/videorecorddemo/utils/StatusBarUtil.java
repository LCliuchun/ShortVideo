...
public class StatusBarUtil {
    ...
    public static int DEFAULT_COLOR = 0xff000000;
    public static float DEFAULT_ALPHA = 0.0f;//Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP ? 0.2f : 0.3f;
    ...
    public static void darkMode(Activity activity) {
        if (Build.VERSION.SDK_INT >= 23) {
            darkMode(activity.getWindow(), Color.WHITE,0);
        } else {
